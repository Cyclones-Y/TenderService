...
create table biz_tender_info (
  ...
  bid_control_price    decimal(18, 6) default null                           comment '招标控制价（万元）',
  bid_price            decimal(18, 6) default null                           comment '中标价（万元）',
  ...
  evaluation_report_1  varchar(255)   default null                           comment '评标报告_1',
  evaluation_report_2  varchar(255)   default null                           comment '评标报告_2',
  evaluation_report_3  varchar(255)   default null                           comment '评标报告_3',
  discount_rate        varchar(20) default null                           comment '中标下浮率（%）',
